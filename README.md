...
[Wang et al. 2018](https://doi.org/10.1038/s41551-018-0301-3) | 88.24% (f) \{P\} [CVC-ClinicDB] <br/> 94.38% (f) \{P\} [P (dataset A)] <br/> 91.64% (f), 100% (p) \{P\} [P (dataset C)] | 93.14% (f) \{P\} [CVC-ClinicDB] <br/> 95.76% (f) \{P\} [P (dataset A)] | 95.40% (f) \{[P]\} [P (dataset D)] | F1: 0.91, F2: 0.89 (f) \{P\} [CVC-ClinicDB] <br/> F1: 0.95, F2: 0.95, AUC: 0.984 (f) \{P\} [P (dataset A)] | Yes (dataset A, CVC-ClinicDB) <br/> No (dataset C/D)
...
[Li K. et al. 2021](http://doi.org/10.1371/journal.pone.0255809) | Adenoma vs. Hyperplastic | 86.8% \{[KUMC]\} | N/A | 85.8% \{[KUMC]\} | N/A | F1: 0.863 \{[KUMC]\} | polyp | image dataset
...
[Li K. et al. 2021](http://doi.org/10.1371/journal.pone.0255809) | Adenoma vs. Hyperplastic | Adenoma: AP =  81.1% \{[KUMC]\} <br/> Hyperplastic: AP = 65.9% \{[KUMC]\} | mAP = 73.5% \{[KUMC]\} | 61.3% \{[KUMC]\} | 86.3% \{[KUMC]\} | 92.2% \{[KUMC]\} | 49.1% \{[KUMC]\} | F1: 0.736 \{[KUMC]\} | Yes
